...
> Answer: client-side routing alows for the rendering of components on the page without having to make html get calls to the server and without refreshing the page.
